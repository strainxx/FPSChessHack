...
static_assert(sizeof(AWaterBody) == 0x000DD0, "Wrong size on AWaterBody");
...
static_assert(offsetof(AWaterBody, WaterBodyType) == 0x0007C0, "Member 'AWaterBody::WaterBodyType' has a wrong offset!");
static_assert(offsetof(AWaterBody, CurveSettings) == 0x0007C8, "Member 'AWaterBody::CurveSettings' has a wrong offset!");
static_assert(offsetof(AWaterBody, WaterMaterial) == 0x0007E8, "Member 'AWaterBody::WaterMaterial' has a wrong offset!");
static_assert(offsetof(AWaterBody, UnderwaterPostProcessMaterial) == 0x0007F0, "Member 'AWaterBody::UnderwaterPostProcessMaterial' has a wrong offset!");
static_assert(offsetof(AWaterBody, bAffectsLandscape) == 0x0007F8, "Member 'AWaterBody::bAffectsLandscape' has a wrong offset!");
static_assert(offsetof(AWaterBody, bGenerateCollisions) == 0x0007F9, "Member 'AWaterBody::bGenerateCollisions' has a wrong offset!");
static_assert(offsetof(AWaterBody, bOverrideWaterMesh) == 0x0007FA, "Member 'AWaterBody::bOverrideWaterMesh' has a wrong offset!");
static_assert(offsetof(AWaterBody, WaterMeshOverride) == 0x000800, "Member 'AWaterBody::WaterMeshOverride' has a wrong offset!");
...
static_assert(offsetof(AWaterBody, CollisionProfileName) == 0x00080C, "Member 'AWaterBody::CollisionProfileName' has a wrong offset!");
static_assert(offsetof(AWaterBody, SplineComp) == 0x000818, "Member 'AWaterBody::SplineComp' has a wrong offset!");
static_assert(offsetof(AWaterBody, WaterSplineMetadata) == 0x000820, "Member 'AWaterBody::WaterSplineMetadata' has a wrong offset!");
static_assert(offsetof(AWaterBody, WaterMID) == 0x000828, "Member 'AWaterBody::WaterMID' has a wrong offset!");
static_assert(offsetof(AWaterBody, UnderwaterPostProcessMID) == 0x000830, "Member 'AWaterBody::UnderwaterPostProcessMID' has a wrong offset!");
static_assert(offsetof(AWaterBody, Islands) == 0x000838, "Member 'AWaterBody::Islands' has a wrong offset!");
static_assert(offsetof(AWaterBody, ExclusionVolumes) == 0x000848, "Member 'AWaterBody::ExclusionVolumes' has a wrong offset!");
static_assert(offsetof(AWaterBody, Landscape) == 0x000858, "Member 'AWaterBody::Landscape' has a wrong offset!");
static_assert(offsetof(AWaterBody, CurrentPostProcessSettings) == 0x000860, "Member 'AWaterBody::CurrentPostProcessSettings' has a wrong offset!");
static_assert(offsetof(AWaterBody, bCanAffectNavigation) == 0x000DB0, "Member 'AWaterBody::bCanAffectNavigation' has a wrong offset!");
static_assert(offsetof(AWaterBody, WaterNavAreaClass) == 0x000DB8, "Member 'AWaterBody::WaterNavAreaClass' has a wrong offset!");
static_assert(offsetof(AWaterBody, WaterWaves) == 0x000DC0, "Member 'AWaterBody::WaterWaves' has a wrong offset!");
static_assert(offsetof(AWaterBody, bHasWaveSpectrumSettings) == 0x000DC8, "Member 'AWaterBody::bHasWaveSpectrumSettings' has a wrong offset!");
static_assert(offsetof(AWaterBody, bHasTerrainCarvingSettingsSettings) == 0x000DC9, "Member 'AWaterBody::bHasTerrainCarvingSettingsSettings' has a wrong offset!");
...
static_assert(sizeof(AWaterBodyCustom) == 0x000DE0, "Wrong size on AWaterBodyCustom");
static_assert(offsetof(AWaterBodyCustom, CustomGenerator) == 0x000DD0, "Member 'AWaterBodyCustom::CustomGenerator' has a wrong offset!");
...
static_assert(sizeof(AWaterBodyLake) == 0x000DE0, "Wrong size on AWaterBodyLake");
static_assert(offsetof(AWaterBodyLake, LakeGenerator) == 0x000DD0, "Member 'AWaterBodyLake::LakeGenerator' has a wrong offset!");
...
static_assert(sizeof(AWaterBodyOcean) == 0x000DF0, "Wrong size on AWaterBodyOcean");
static_assert(offsetof(AWaterBodyOcean, OceanGenerator) == 0x000DD0, "Member 'AWaterBodyOcean::OceanGenerator' has a wrong offset!");
static_assert(offsetof(AWaterBodyOcean, CollisionExtents) == 0x000DD8, "Member 'AWaterBodyOcean::CollisionExtents' has a wrong offset!");
static_assert(offsetof(AWaterBodyOcean, HeightOffset) == 0x000DE4, "Member 'AWaterBodyOcean::HeightOffset' has a wrong offset!");
...
static_assert(sizeof(AWaterBodyRiver) == 0x000E00, "Wrong size on AWaterBodyRiver");
static_assert(offsetof(AWaterBodyRiver, RiverGenerator) == 0x000DD0, "Member 'AWaterBodyRiver::RiverGenerator' has a wrong offset!");
static_assert(offsetof(AWaterBodyRiver, LakeTransitionMaterial) == 0x000DD8, "Member 'AWaterBodyRiver::LakeTransitionMaterial' has a wrong offset!");
static_assert(offsetof(AWaterBodyRiver, LakeTransitionMID) == 0x000DE0, "Member 'AWaterBodyRiver::LakeTransitionMID' has a wrong offset!");
static_assert(offsetof(AWaterBodyRiver, OceanTransitionMaterial) == 0x000DE8, "Member 'AWaterBodyRiver::OceanTransitionMaterial' has a wrong offset!");
static_assert(offsetof(AWaterBodyRiver, OceanTransitionMID) == 0x000DF0, "Member 'AWaterBodyRiver::OceanTransitionMID' has a wrong offset!");
...
static_assert(offsetof(UWaterMeshComponent, RTWorldLocation) == 0x000484, "Member 'UWaterMeshComponent::RTWorldLocation' has a wrong offset!");
static_assert(offsetof(UWaterMeshComponent, RTWorldSizeVector) == 0x000490, "Member 'UWaterMeshComponent::RTWorldSizeVector' has a wrong offset!");
static_assert(offsetof(UWaterMeshComponent, TessellationFactor) == 0x000580, "Member 'UWaterMeshComponent::TessellationFactor' has a wrong offset!");
static_assert(offsetof(UWaterMeshComponent, LODScale) == 0x000584, "Member 'UWaterMeshComponent::LODScale' has a wrong offset!");
...
static_assert(offsetof(UWaterSplineComponent, PreviousWaterSplineDefaults) == 0x000548, "Member 'UWaterSplineComponent::PreviousWaterSplineDefaults' has a wrong offset!");
